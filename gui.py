...
+ Anzeige der internen und externen IP-Adresse
"""
...
class FritzWidget(QWidget):
    ...
    def update_bandwidth(self):
        ...
        try:
            lan_ip, wan_ip = self.reader.get_ip_addresses()
            self.ip_label.setText(f"LAN: {lan_ip}  |  WAN: {wan_ip}")
        except AttributeError:
            self.ip_label.setText("LAN/WAN IP nicht verfügbar")
